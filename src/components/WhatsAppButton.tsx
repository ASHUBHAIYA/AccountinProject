  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className="p-4">
          <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
            Hello! 👋 Need help with GST filing, ITR, or accounting? Chat with us on WhatsApp for instant assistance!
          </p>
          <p className="text-xs text-green-600 font-medium mb-3">
            ⚡ We reply within 10-15 minutes
          </p>
          <a 
            href={whatsappUrl} 
            target="_blank" 
            rel="noopener noreferrer"
            className="block w-full py-3 px-4 bg-[#25D366] hover:bg-[#1fb956] text-white text-center rounded-md transition-colors font-semibold"
          >
            Chat on WhatsApp
          </a>
        </div>
      ...
      >
        <svg 
          className={cn(
            "h-7 w-7 fill-white transition-all duration-300",
